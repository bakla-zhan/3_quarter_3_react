...
class _Header extends Component {
    static propTypes = {
        ...
        chats: PropTypes.array, // получаем массив с названиями чатов
    };
    ...
    render() {
        return (
            <header className='header'>
                ...
                <div className='chatname' >{this.props.currentChat ? this.props.chats[this.props.currentChat - 1] : null}</div>
